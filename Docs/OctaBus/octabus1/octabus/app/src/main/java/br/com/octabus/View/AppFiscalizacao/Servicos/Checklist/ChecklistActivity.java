package br.com.octabus.View.AppFiscalizacao.Servicos.Checklist;
...
import br.com.octabus.View.AppFiscalizacao.Servicos.ChecklistComunicacao.ChecklistComunicacaoActivity;
...
public class ChecklistActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getResources().getString(R.string.tituloChecklist));
    ...
    {
        TypedArray imagem = getResources().obtainTypedArray(R.array.imagemServicoChecklist);
        String[] titulo = getResources().getStringArray(R.array.tituloServicoChecklist);
        ...
        /* ADAPTER */
        Adapter opcaoAdapter = new ChecklistItemAdapter(getApplicationContext(), lista);
        ...
        listviewItem.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, final View view, int position, long id) {
                ...
                if(position == 0)
                {
                    Intent intent = new Intent(ChecklistActivity.this,ChecklistComunicacaoActivity.class);
                    startActivity(intent);
                }
                else if(position == 1)
                {
