...
public class InformacaoPontoComunicacaoItemAdapter extends BaseAdapter {
    private Context context;
    public List listaItem;
    public String complemento;
    public String checked;

    public InformacaoPontoComunicacaoItemAdapter(Context context, List listaItem) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    if(item.getInt("obrigatorioJustificativa_id") == 1)
                    {
